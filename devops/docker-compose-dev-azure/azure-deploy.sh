...
resourcename="accessmanagementiter12"  # lower case, only
resourcegroup="accessmanagementiter12_rg"
...
# git clone https://github.com/apilogicserver/accessmanagementiter12.git
# cd accessmanagementiter12
...
az group create --name accessmanagementiter12_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group accessmanagementiter12_rg --sku S1 --is-linux
az container create --resource-group accessmanagementiter12_rg --name accessmanagementiter12 --image apilogicserver/accessmanagementiter12:latest --dns-name-label accessmanagementiter12 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//accessmanagementiter12.westus.azurecontainer.io:5656'
